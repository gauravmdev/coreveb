...
export async function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-3.5 py-3 text-white shadow-lg shadow-[#25D366]/30 transition-all hover:px-4 hover:shadow-xl hover:shadow-[#25D366]/40 sm:bottom-6 sm:right-6"
    >
